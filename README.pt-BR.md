...
ailake-store = "0.1.8"   # backends S3 / GCS / Azure / local
```
...
```bash
TAG=v0.1.8            # tag do release GitHub (versão Rust/PyPI)
JAR_VERSION=0.1.8     # versão do plugin JVM (gradle, versionado à parte — confira a página do release)
