...
// index type flags (bits 0–2 of header.flags)
...
static constexpr uint16_t kFlagIndexBinary = 0x0004; // bit 2: Binary Hamming flat index
...
struct AilakeHeader {
    ...
    bool is_binary()  const noexcept { return (flags & kFlagIndexBinary) != 0; }
};
