...
val spark = SparkSession.builder()
  .config("spark.jars", "/path/to/spark-plugin-0.1.12-plugin.jar")
  .config("spark.sql.extensions",
    "org.apache.iceberg.spark.extensions.IcebergSparkSessionExtensions," +
...
cd ailake-flink
./gradlew shadowJar
# Output: build/libs/ailake-flink-0.1.12-plugin.jar
```
...
2. Copy `ailake-flink-0.1.12-plugin.jar` to `$FLINK_HOME/lib/`
